...
const vec3 u_lightPos = vec3(0.0, 2.0, 1.0);
const vec3 u_diffuseColor = vec3(1.0, 1.0, 1.0);
const vec3 u_specularColor = vec3(0.937, 0.9098, 0.8431);

const vec4 Light_position = vec4(0.0, 2.0, 1.0, 1.0);
const vec3 Light_intensities = vec3(0.937, 0.9098, 0.8431);
const float Light_attenuation = 0.0001;
const float Light_ambientCoefficient = 1.0;
const float Light_coneAngle = 180.0;
const vec3 Light_coneDirection = vec3(0.0,-0.1,1.0);
